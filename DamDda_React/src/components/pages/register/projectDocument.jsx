...
const ProjectDocument = () => {
  ...
  const handleFileUpload = (event, setFileList) => {
  ...
  const handleFileDelete = (index, fileList, setFileList) => {
  ...
  return (
    <div style={{ marginTop: "40px" }}>
      ...
      >
        ...
        <VisuallyHiddenInput
          type="file"
          onChange={(event) => handleFileUpload(event, setRequiredDocs)}
          multiple
        />
      </Button>
      <Paper
        ...
        <FileContainer>
          {requiredDocs.map((fileName, index) => (
            <FileItem key={index}>
              ...
              <IconButton
                onClick={() =>
                  handleFileDelete(index, requiredDocs, setRequiredDocs)
                }
      ...
      >
        ...
        <VisuallyHiddenInput
          type="file"
          onChange={(event) => handleFileUpload(event, setCertificationDocs)}
          multiple
        />
      </Button>
      <Paper
