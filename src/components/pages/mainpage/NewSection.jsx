...
const cardData = [
  {
    ...
    buttonText: '자세히 보기',
    imageUrl: new_section_image1, // Replace with actual image URL
  },
  {
    title: '프로모션',
    description: '최대 50% 할인! 지금 펀딩에 참여하고 특별 혜택을 누리세요.',
    buttonText: '자세히 보기',
    imageUrl: new_section_image2, // Replace with actual image URL
  },
  {
    title: '전통 문화 성공 사례',
    description: '혁신적인 아이디어로 3천만원 펀딩을 달성한 프로젝트 소개.',
    buttonText: '자세히 보기',
    imageUrl: new_section_image3, // Replace with actual image URL
  },
  {
    title: 'K-POP 새로운 프로젝트',
    description: '최신 펀딩 프로젝트에 지금 참여하세요!',
    buttonText: '자세히 보기',
    imageUrl: new_section_image4, // Replace with actual image URL
  },
];
